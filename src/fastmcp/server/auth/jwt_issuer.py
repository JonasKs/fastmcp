...
class JWTIssuer:
    ...
    def issue_access_token(
        ...
        Args:
            ...
            upstream_claims: Optional claims from the upstream token to embed
                in the JWT. These are added under the "upstream_claims" key,
                allowing gateways to inspect upstream identity without lookups.
